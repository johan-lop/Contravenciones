 ...
 */
package co.com.contravenciones.modelo.seguridad;
...
@NamedQueries({
    @NamedQuery(name = "Menu.findSubMenuDtoByRol", 
            query = "select new co.com.contravenciones.dtos.seguridad.SubMenuDto"
            + "(m.id, m.titulo) from Menu m where m.rol.id = :rolId and m.padreId is null"),
    @NamedQuery(name = "Menu.findMenuItemDtoBySubMenuAndRol", 
            query = "select new co.com.contravenciones.dtos.seguridad.MenuItemDto"
